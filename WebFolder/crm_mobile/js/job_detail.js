/*
File Name: job_detail.js
Description: Document gets job detail from database and sends back json data
Author: Chetan Sharma
Created On: ‎Friday, ‎August ‎03, ‎2012, ‏‎1:25:17 PM
*/
...
function displayJob(data) {
	var job = data.item;
	console.log(job);
	$('#applyButton').html('<a data-role="button" data-transition="fade" data-theme="a" href="applynow.php?jobId='+job.ID+'" class="ui-btn-left">Apply</a>').trigger( "create" );
	...
	$('#emailme').html('<a data-role="button" data-transition="fade" data-theme="a" href="email_me_jobs.php?jobId='+job.ID+'" class="ui-btn-left">Email me jobs like this</a>').trigger( "create" );
