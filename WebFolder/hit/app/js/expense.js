...
$(function() {
  ...
  $("#addrow").click(function(){
	 $('#items').find(".cancellink").trigger('click');
    $(".item").after('<tr class="item-row"><td class="item-id"><span class="s_type" style="display:none;" ></span><div class="ui-select div_type"><select class="type" name="type" ><option value="">--Type--</option>'+type_options+'</select></div><input class="item_uuid" type="hidden" /></td><td ><span class="s_description" style="display:none" ></span><div><textarea class="description" name="description"></textarea></div></td><td><span class="s_amount" style="display:none;" ></span><div><input type="text" class="amount" name="amount" ></div></td><td ><a href="javascript:void(0)" class="editlink" style="display:none">Edit</a><a href="javascript:void(0)" class="savelink" >Save</a></td><td><a href="javascript:void(0)" class="removelink" style="display:none" >Remove</a><a href="javascript:void(0)" class="cancellink" >Cancel</a></td></tr>');
