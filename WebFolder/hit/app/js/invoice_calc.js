...
<!--#4DIF (Records in selection([Invoices])=1)-->		   
  ...
  $("#addrow").click(function(){
	$('#items').find(".cancellink").trigger('click');
    $(".item").after('<tr class="item-row"><td class="item-id"><span class="item_id"></span><input class="item_uuid" type="hidden" /></td><td ><span class="s_description" style="display:none" ></span><div><textarea class="description" name="description"></textarea></div></td><td><span class="s_rate" style="display:none" ></span><div><input type="text" class="rate num" name="rate" value="0" style="width:50px" ></div></td><td><span class="s_hours" style="display:none" ></span><div><input type="text" class="hours num" name="hours" value="0" style="width:50px" ></div></td><td><span class="price">0</span></td><td ><a href="javascript:void(0)" class="editlink" style="display:none">Edit</a><a href="javascript:void(0)" class="savelink" >Save</a></td><td><a href="javascript:void(0)" class="removelink" style="display:none" >Remove</a><a href="javascript:void(0)" class="cancellink" >Cancel</a></td></tr>');
