...
success: function(html)
{
	...
	row.find('.item_id').html(result[0]);

	row.find('.item_uuid').val(result[1]);
//$('#items').html(html);
...
var dataString = 'id='+ id+'&delitem_uuid='+ivcnitem_uuid;

$.ajax({
type: "GET",
url: "deleteinvoiceitem.cgi",
data: dataString,
cache: false,
success: function(html)
{
...
$(function() {
  ...
  //$("#Client_ID").change(get_client_info);
   
  $("#addrow").click(function(){
    $(".item").after('<tr class="item-row"><td class="item-id"><span class="item_id"></span><input class="item_uuid" type="hidden" /></td><td ><span class="s_description" style="display:none" ></span><textarea class="description"></textarea></td><td><span class="s_rate" style="display:none" ></span><input type="text" class="rate num1" value="0" style="width:50px" ></td><td><span class="s_hours" style="display:none" ></span><input type="text" class="hours num1" value="0" style="width:50px" ></td><td><span class="price">0</span></td><td ><a href="javascript:void(0)" class="editlink" style="display:none">Edit</a><a href="javascript:void(0)" class="savelink" >Save</a></td><td><a href="javascript:void(0)" class="removelink" style="display:none" >Remove</a><a href="javascript:void(0)" class="cancellink" >Cancel</a></td></tr>');
