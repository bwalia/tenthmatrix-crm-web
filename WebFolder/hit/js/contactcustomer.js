...
$(function() {
  ...
  $("#addrow").click(function(){
    $(".item").after('<tr class="item-row"><td ><span class="s_firstname" style="display:none" ></span><input class="contact_uuid" type="hidden" value="" /><input type="text" class="firstname form-control"></td><td><span class="s_surname" style="display:none" ></span><input type="text" class="surname form-control" ></td><td><span class="s_email" style="display:none" ></span><input type="text" class="email form-control" ></td><td><span class="s_mobile" style="display:none" ></span><input type="text" class="mobile form-control"></td><td ><a href="javascript:void(0)" class="editlink" style="display:none" title="Edit"><i class="fa fa-pencil"></i></a><a href="javascript:void(0)" class="savelink" title="Save"><i class="fa fa-save"></i></a></td><td><a href="javascript:void(0)" class="removelink" style="display:none" title="Remove"><i class="fa fa-trash"></i></a><a href="javascript:void(0)" class="cancellink" title="Cancel"><i class="fa fa-remove"></i></a></td></tr>');
