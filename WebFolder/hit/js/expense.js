...
$(function() {
  ...
  $("#addrow").click(function(){
    $(".item").after('<tr class="item-row"><td class="item-id"><span class="s_type" style="display:none;" ></span><div class="ui-select div_type"><select class="type" ><option value="">--Type--</option>'+type_options+'</select></div><input class="item_uuid" type="hidden" /></td><td ><span class="s_description" style="display:none" ></span><textarea class="description"></textarea></td><td><span class="s_amount" style="display:none;" ></span><input type="text" class="amount" ></td><td ><a href="javascript:void(0)" class="editlink" style="display:none">Edit</a><a href="javascript:void(0)" class="savelink" >Save</a></td><td><a href="javascript:void(0)" class="removelink" style="display:none" >Remove</a><a href="javascript:void(0)" class="cancellink" >Cancel</a></td></tr>');
