...
(function (factory) {
    ...
    defaultFileActionSettings = {
        removeIcon: '<i class="glyphicon glyphicon-trash icon-trash text-danger"></i>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="glyphicon glyphicon-upload icon-upload text-info"></i>',
        uploadClass: 'btn btn-xs btn-default',
        uploadTitle: 'Upload file',
        indicatorNew: '<i class="glyphicon glyphicon-hand-down  icon-hand-down text-warning"></i>',
        indicatorSuccess: '<i class="glyphicon glyphicon-ok-sign icon-ok text-success"></i>',
        indicatorError: '<i class="glyphicon glyphicon-exclamation-sign  icon-exclamation-sign text-danger"></i>',
        indicatorLoading: '<i class="glyphicon glyphicon-hand-up  icon-hand-up text-muted"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewFileIcon: '<i class="glyphicon glyphicon-file icon-picture"></i>',
        previewFileIconClass: 'file-icon-4x',
        previewFileIconSettings: {},
        previewFileExtSettings: {},
        buttonLabelClass: 'hidden-xs',
        browseIcon: '<i class="glyphicon glyphicon-folder-open icon-picture"></i>&nbsp;',
