...
{	
 ...
 $(function() {
   ...
   $("#addcontact").click(function(){
     $('#tbl_contact').find("tr.item").after('<tr class="item-row" ><td><span class="s_forename" style="display:none;" ></span><input class="contact_uuid form-control" type="hidden" /><input type="text" class="form-control forename"  ></td><td ><span class="s_surname" style="display:none;" ></span><input type="text" class="form-control surname" ></td><td><span class="s_email" style="display:none;" ></span><input type="text" class="email form-control" ></td><td><span class="s_mobile" style="display:none;" ></span><input type="text" class="mobile phone form-control" ></td><td ><a href="javascript:void(0)" class="con_editlink" style="display:none;" title="Edit"><i class="fa fa-pencil"></i></a><a href="javascript:void(0)" class="con_savelink" title="Save"><i class="fa fa-save"></i></a></td><td><a href="javascript:void(0)" class="con_removelink" style="display:none;" title="Remove"><i class="fa fa-trash"></i></a><a href="javascript:void(0)" class="con_cancellink" title="Cancel"><i class="fa fa-remove"></i></a></td></tr>');
   ...
   $("#addactivity").click(function(){
     $('#items').find("tr.item").after('<tr class="item-row"><td><span class="s_ContactName" style="display:none;" ></span><input class="activity_uuid" type="hidden" /><input type="text" class="ContactName form-control"  ></td><td ><span class="s_action" style="display:none;" ></span><input type="text" class="form-control action" ></td><td><span class="s_phone" style="display:none;" ></span><input type="text" class="phone form-control" ></td><td><span class="s_owner" style="display:none;" ></span><input type="text" class="form-control owner" ></td><td><a href="javascript:void(0)" class="act_editlink" style="display:none;" title="Edit"><i class="fa fa-pencil"></i></a><a href="javascript:void(0)" class="act_savelink" title="Save"><i class="fa fa-save"></i></a></td><td><a href="javascript:void(0)" class="act_removelink" style="display:none;" title="Remove"><i class="fa fa-trash"></i></a><a href="javascript:void(0)" class="act_cancellink" title="Cancel"><i class="fa fa-remove"></i></a></td></tr>');
