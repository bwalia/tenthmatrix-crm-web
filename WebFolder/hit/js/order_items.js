...
<!--#4DENDIF-->
 ...
 // $("#paid").blur(update_balance);
  ...
  $("#addrow").click(function(){
	...
	$('#items').find(".cancellink").trigger('click');
    $(".item").after('<tr class="item-row"><td class="item-id"><span class="item_id"></span><input class="item_uuid" type="hidden" /></td><td ><span class="s_description" style="display:none" ></span><input class="description form-control" type="hidden" /><div class="ui-widget div_i_description"><select name="product" id="get_products" class="i_description form-control"></select></div></td><td><span class="s_rate" style="display:none" ></span><div><input type="text" class="rate num form-control" name="rate" value="0" style="width:50px"></div></td><td><span class="s_hours" style="display:none" ></span><div><input type="text" class="hours num form-control" name="hours" value="0" style="width:50px" ></div></td><td><span class="s_discount" style="display:none" ></span><div><input type="text" class="i_discount num form-control" name="i_discount" value="0" style="width:50px" ></div></td><td><span class="price">0</span></td><td ><a href="javascript:void(0)" class="editlink" style="display:none" title="Edit"><i CLASS="fa fa-pencil"></i></a><a href="javascript:void(0)" class="savelink" title="Save"><i CLASS="fa fa-save"></i></a></td><td><a href="javascript:void(0)" class="removelink" style="display:none" title="Remove"><i CLASS="fa fa-trash"></i></a><a href="javascript:void(0)" class="cancellink" title="Cancel"><i CLASS="fa fa-remove"></i></a></td></tr>');
