...
$(function() {
	$("#add_db_details").click(function(){
    	$(".db_item").after('<tr class="db-item-row"><td><span class="s_db_selected" style="display:none"></span><div class="i_db_selected ui-select"><select class="db_selected" name="db_selected"><option value="mysql" >Mysql</option><option value="mongodb">Mongo DB</option></select></div></td><td><span class="s_server_type" style="display:none"></span><div class="i_server_type ui-select"><select class="server_type" name="server_type"><option value="Dev">Dev</option><option value="Staging">Staging</option><option value="Live">Live</option></select></div></td><td><input class="db_uuid" type="hidden" /><span class="s_db_host_name" style="display:none"></span><input type="text" class="i_db_host_name" value="" ></td><td><span class="s_db_user_name" style="display:none"></span><input type="text" class="i_db_user_name" value="" ></td><td><span class="s_db_password" style="display:none" ></span><input type="password" class="i_db_password" value="" ></td><td><span class="s_db_name"></span><input type="text" class="i_db_name" value=""></td><td ><a href="javascript:void(0)" class="editdblink" style="display:none">Edit</a><a href="javascript:void(0)" class="savedblink" >Save</a></td><td><a href="javascript:void(0)" class="removedblink" style="display:none" >Remove</a><a href="javascript:void(0)" class="canceldblink" >Cancel</a></td></tr>');
