...
{	
 ...
 $(function() {
   ...
   $("#addactivity").click(function(){
     $('#tbl_activity').find("tr.item").after('<tr class="item-row"><td><span class="s_ContactName" style="display:none;" ></span><input class="activity_uuid" type="hidden" /><input type="text" class="ContactName"  ></td><td ><span class="s_action" style="display:none;" ></span><input type="text" class="action" ></td><td><span class="s_phone" style="display:none;" ></span><input type="text" class="phone" ></td><td><span class="s_owner" style="display:none;" ></span><input type="text" class="owner" ></td><td><a href="javascript:void(0)" class="act_editlink" style="display:none;">Edit</a><a href="javascript:void(0)" class="act_savelink" >Save</a></td><td><a href="javascript:void(0)" class="act_removelink" style="display:none;" >Remove</a><a href="javascript:void(0)" class="act_cancellink" >Cancel</a></td></tr>');
