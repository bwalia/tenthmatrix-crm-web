...
$(function() {
	$("#a_addrow").click(function(){
		$("#a_records").prepend('<tr class="item-row"><td><input type="checkbox" class="a_chk" ><input type="hidden" class="uuid" value=""/></td><td><span class="s_a_host" style="display:none" ></span><input class="a_host" type="text" value=""/></td><td ><span class="s_a_ttl" style="display:none" ></span><input type="text" class="a_ttl" value=""></td><td><span class="s_type" style="display:none" ></span><div class="ui-select div_type"><select class="type" ><option value="IN A">IN A</option><option value="IN AAAA">IN AAAA</option><option value="IN CNAME">IN CNAME</option></select></div></td><td><span class="s_a_target" style="display:none" ></span><input type="text" class="a_target" value=""  ></td><td><span class="s_a_cmnt" style="display:none" ></span><input type="text" class="a_cmnt" value="" ></td><td align="left"><a href="javascript:void(0)" class="editlink" style="display:none" title="Edit"><i class="table-edit"></i></a><a href="javascript:void(0)" title="Save" class="savelink" style="text-decoration: none;"><i class="table-save"></i></a>&nbsp;&nbsp;<a href="javascript:void(0)" class="removelink" style="display:none" title="Delete"><i class="table-delete"></i></a><a href="javascript:void(0)" style="text-decoration: none;" class="cancellink" title="Cancel"><i class="table-cancel"></i></a></td></tr>');
	...
	$("#mx_addrow").click(function(){
		$("#mx_records").prepend('<tr class="item-row"><td><input type="checkbox" class="mx_chk" ><input type="hidden" class="uuid" value=""/></td><td ><span style="display:none;" class="s_mx_host"></span><input class="mx_host" type="text" /></td><td ><span class="s_mx_ttl" style="display:none;"></span><input class="mx_ttl" type="text" /></td><td >IN MX<input class="type" type="hidden" value="IN MX"/></td><td ><span style="display:none;" class="s_mx_prty"></span><input class="mx_prty" type="text" /></td><td ><span style="display:none;" class="s_mx_target"></span><input class="mx_target" type="text" /> </td><td ><span style="display:none;" class="s_mx_cmnt"></span><input class="mx_cmnt" type="text" /></td><td align="left"><a href="javascript:void(0)" class="editlink" style="display:none" title="Edit"><i class="table-edit"></i></a><a href="javascript:void(0)" title="Save" class="savelink" style="text-decoration: none;"><i class="table-save"></i></a>&nbsp;&nbsp;<a href="javascript:void(0)" class="removelink" style="display:none" title="Delete"><i class="table-delete"></i></a><a href="javascript:void(0)" style="text-decoration: none;" class="cancellink" title="Cancel"><i class="table-cancel"></i></a></td></tr>');
		 $("input:checkbox, input:radio").uniform();
	...
	$("#txt_addrow").click(function(){
		$("#txt_records").prepend('<tr class="item-row"><td><input type="checkbox" class="txt_chk" ><input type="hidden" class="uuid" value=""/></td> <td ><span style="display:none;" class="s_txt_host"></span><input class="txt_host" type="text" /></td><td ><span style="display:none;" class="s_txt_ttl"></span><input class="txt_ttl" type="text" /></td><td >IN TXT<input class="type" type="hidden" value="IN TXT"/></td><td ><span style="display:none;" class="s_txt_text">Text</span><input class="txt_text" type="text" /></td><td ><span style="display:none;" class="s_txt_cmnt"></span><input class="txt_cmnt" type="text" /></td><td ><span style="display:none;" class="s_txt_val"></span><div class="ui-select div_txt_val"><select class="txt_val" ><option  value="None">None</option></select></div></td><td align="left"><a href="javascript:void(0)" class="editlink" style="display:none" title="Edit"><i class="table-edit"></i></a><a href="javascript:void(0)" title="Save" class="savelink" style="text-decoration: none;"><i class="table-save"></i></a>&nbsp;&nbsp;<a href="javascript:void(0)" class="removelink" style="display:none" title="Delete"><i class="table-delete"></i></a><a href="javascript:void(0)" style="text-decoration: none;" class="cancellink" title="Cancel"><i class="table-cancel"></i></a></td></tr>');
		$("input:checkbox, input:radio").uniform();
	...
	$("#srv_addrow").click(function(){
		$("#srv_records").prepend('<tr class="item-row"><td><input type="checkbox" class="srv_chk" ><input type="hidden" class="uuid" value=""/></td><td ><span style="display:none;" class="s_srv_service"></span><input class="srv_service" type="text" /></td><td ><span style="display:none;" class="s_srv_proto"></span><input class="srv_proto" type="text" /></td><td ><span style="display:none;" class="s_srv_host"></span><input class="srv_host" type="text" /></td><td ><span style="display:none;" class="s_srv_ttl"></span><input class="srv_ttl" type="text" /></td><td >IN SRV<input class="type" type="hidden" value="IN SRV"/></td><td ><span style="display:none;" class="s_srv_prty"></span><input class="srv_prty" type="text" /></td><td ><span style="display:none;" class="s_srv_wght"></span><input class="srv_wght" type="text" /></td><td ><span style="display:none;" class="s_srv_port"></span><input class="srv_port"  type="text" /></td><td ><span style="display:none;" class="s_srv_target"></span><input class="srv_target"  type="text" /></td><td ><span style="display:none;" class="s_srv_cmnt"></span><input class="srv_cmnt" type="text" /></td><td align="left"><a href="javascript:void(0)" class="editlink" style="display:none" title="Edit"><i class="table-edit"></i></a><a href="javascript:void(0)" title="Save" class="savelink" style="text-decoration: none;"><i class="table-save"></i></a>&nbsp;&nbsp;<a href="javascript:void(0)" class="removelink" style="display:none" title="Delete"><i class="table-delete"></i></a><a href="javascript:void(0)" style="text-decoration: none;" class="cancellink" title="Cancel"><i class="table-cancel"></i></a></td></tr>');
		$("input:checkbox, input:radio").uniform();
