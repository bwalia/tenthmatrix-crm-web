...
function update_total() {
  ...
  total_with_tax = roundNumber(Number(total)+Number(tot_tax),2);
	//console.log(tot_rate+"tax rate");
	//console.log(total);
  	//console.log(total_with_tax+'tax');
...
function save() {
	...
	if(description!='' && rate!='' && amount!='' && hours!='' && rate!=0 && hours!=0){
		if(!isNaN(rate)){
			if(!isNaN(hours)){
				if(ID!=''){
...
$(function() {
  ...
  $("#addrow").click(function(){
    $(".item").after('<tr class="item-row"><td class="item-id"><span class="item_id"></span><input class="item_uuid" type="hidden" /></td><td ><span class="s_description" style="display:none" ></span><textarea class="form-control description"></textarea></td><td><span class="s_rate" style="display:none" ></span><input type="text" class="form-control rate num" value="0" ></td><td><span class="s_hours" style="display:none" ></span><input type="text" class="form-control hours num" value="0"></td><td><span class="price">0</span></td><td ><a href="javascript:void(0)" class="editlink" style="display:none">Edit</a><a href="javascript:void(0)" class="savelink" >Save</a></td><td><a href="javascript:void(0)" class="removelink" style="display:none" >Remove</a><a href="javascript:void(0)" class="cancellink" >Cancel</a></td></tr>');
