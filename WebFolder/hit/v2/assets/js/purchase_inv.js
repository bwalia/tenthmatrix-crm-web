...
$(function() {
  ...
  $("#addrow").click(function(){
	$('#items').find(".cancellink").trigger('click');
    $(".item").after('<tr class="item-row" id=""><td class="item-id"><span class="s_line_number" style="display:none;" ></span><div><input type="text" class="form-control line_number"  name="line_number" value="" ></div><input class="form-control item_id" name="item_id" type="hidden" value="" /><input class="from-control item_uuid" name="item_uuid" type="hidden" value="" /></td><td ><span class="s_item_purchased" style="display:none;" ></span><div><input type="text" class="form-control item_purchased" name="item_purchased"  value="" ></div></td><td><span class="s_item_quantity" style="display:none;" ></span><div><input type="text" class="form-control item_quantity num"  name="item_quantity" value="" ></div></td><td><span class="s_item_unit_price" style="display:none;" ></span><div><input type="text" class="form-control num item_unit_price" name="item_unit_price" value="" ></div></td><td><span class="s_item_total" ></span></td><td><a href="javascript:void(0)" class="editlink" style="display:none;">Edit</a><a href="javascript:void(0)" class="savelink" >Save</a></td><td><a href="javascript:void(0)" class="removelink" style="display:none;" >Remove</a><a href="javascript:void(0)" class="cancellink" >Cancel</a></td></tr>');
